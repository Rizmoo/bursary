...
class ApplicantsBeneficiariesExcelController extends Controller
{
    public function __invoke(Request $request, Ward $tenant): BinaryFileResponse
    {
        ...
        return Excel::download(new ApplicantsBeneficiariesExport($tenant->getKey(), $ids, $tenant->name), $filename);
    }
}
